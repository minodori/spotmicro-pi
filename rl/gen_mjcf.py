...
치수를 URDF 에서 가져오지 않는 이유:
  ...
  urdf/spotmicroai_gen.urdf.xml 은 실물과 다르다. 하퇴가 115mm 로 실측 138 보다
  17% 짧고, l2(20mm) 는 통째로 빠져 있으며, 질량 합계가 5.3kg 로 실측 2.2kg 의
  2.4배다. 관성 텐서는 12개가 1000, 8개가 100 인 플레이스홀더다.
...
# 서보 최대 토크 (N·m). DS3235 는 35kg·cm ≈ 3.43, 여유를 보고 3.0 을 쓴다.
...
# DS3235 무부하 545°/s = 9.51 rad/s -> 3.0/9.51 = 0.315
